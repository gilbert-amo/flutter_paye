...
void _printTaxCalculation(TaxResult result) {
  ...
  print('\nTax Breakdown:');
  print('Personal Allowance: £${result.taxBreakdown['personalAllowance']?.toStringAsFixed(2) ?? '0.00'}');
  print('Basic Rate: £${result.taxBreakdown['basicRate']?.toStringAsFixed(2) ?? '0.00'}');
  print('Higher Rate: £${result.taxBreakdown['higherRate']?.toStringAsFixed(2) ?? '0.00'}');
  print('Additional Rate: £${result.taxBreakdown['additionalRate']?.toStringAsFixed(2) ?? '0.00'}');
}
